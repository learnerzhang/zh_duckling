...
main :: IO ()
main = do
  let zh = makeLocale ZH Nothing
  debug zh "testing my dimension" [This (CustomDimension MyDimension)] >>= print
  debug zh "testing my dimension pattern match" [This (CustomDimension MyDimension)] >>= print
